...
public struct SyncLog: Identifiable, Codable {
    ...
    public struct SyncedFileInfo: Codable {
        ...
        public init(path: String, fileName: String, folderName: String?, size: Int64, operation: FileOperation) {
            self.path = path
    ...
    public init(id: UUID = UUID(), syncID: String, folderID: UUID, peerID: String?, direction: Direction, bytesTransferred: Int64, filesCount: Int, startedAt: Date, completedAt: Date? = nil, errorMessage: String? = nil, syncedFiles: [SyncedFileInfo]? = nil) {
        self.id = id
        self.syncID = syncID
