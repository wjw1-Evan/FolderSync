...
public class FSEventsMonitor {
    ...
    public init(path: String, callback: @escaping (String, FSEventStreamEventFlags) -> Void) {
        self.path = path
    ...
    public func start() {
        ...
        stream = FSEventStreamCreate(
            ...
            { (streamRef, clientCallBackInfo, numEvents, eventPaths, eventFlags, eventIds) in
                let monitor = Unmanaged<FSEventsMonitor>.fromOpaque(clientCallBackInfo!)
                    .takeUnretainedValue()
